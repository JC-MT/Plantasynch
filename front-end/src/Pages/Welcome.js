...
export default function Welcome({loggedInUser, setLoggedInUser}){
    ...
    return(
        <div className='flex absolute flex-col w-screen overflow-x-hidden'>
            ...
            <div className='bg-transparent w-screen h-[555px] tablet:hidden'
            style={{background: `url(${bgW}) center no-repeat fixed`, backgroundSize: '90vmax 100vmax', backgroundPositionY: `${-30 - scrollTop / 15}px`}}></div>
