...
export default function Home({loggedInUser, notification, reFetch}){
    ...
    return(
        <div className="flex flex-col tablet:pt-8">
            <div className="flex flex-row justify-left p-3 tablet:pt-10 tablet:px-[10%]">
            ...
            <p className="text-left p-2 pt-0 tablet:px-[10%]">Feel free to discover/add new plants from the <em>"Explore"</em> page or simple add your plants with the <em>"Add"</em> page.</p>
