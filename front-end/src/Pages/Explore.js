...
export default function Explore(){
    ...
    return(
        <div>
            <div className="tablet:px-[12%] flex flex-row p-2 justify-left tablet:pt-12">
            ...
            <p className="tablet:px-[12%] p-2 text-left text-[15px] pt-0 tablet:text-left">Click on plant for details or to add to your garden</p>
            <ExploreIndex/>
            <Footer/>
        </div>
    )
