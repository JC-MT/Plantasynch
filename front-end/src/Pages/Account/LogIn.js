...
export default function LogIn({ setLoggedInUser }) {
  ...
  const notify = (result, name) => {
    return result
      ? toast.success(`You are logged in, ${name}. Happy Growing 🪴`, {
      ...
      : toast.error(
          `We were unable to log you in 🥲 Please check your internet or change your credentials to match our database.`,
          {
            position: 'bottom-center',
            autoClose: 3000,
            hideProgressBar: false,
