  ...
  return (
    <div>
      <form
        ...
        className="flex flex-col place-items-center tablet:pb-8"
      >
        <img
          alt="garden of house plants"
          className="pt-3 rounded-md shadow-md place-self-center w-[250px] h-[150px] tablet:w-[600px] tablet:h-[350px]"
          src={`https://getplanta.com/images/feature_2.webp`}
        />
        <p className="p-1 text-center text-[15px] tablet:text-[15px]">
          *Plantasynch needs at least a name to add your new plant
        </p>
        <div className="flex flex-row place-content-center">
          ...
          <input
            value="Add Plant"
            type="submit"
            className="m-0 button-style w-full"
          />
        </div>
        ...
        <div className="flex flex-col input-container">
          <label className="input-label" htmlFor="ideal_light">
            Prefered Light:
          </label>
          <select
            name="ideal_light"
        ...
        <div className="flex flex-col input-container">
          <label className="input-label" htmlFor="ideal_watering">
            Water Preference:
          </label>
          <select
            name="ideal_watering"
        ...
        <div className="flex flex-col input-container">
          <label className="input-label" htmlFor="last_water">
            Last Time Watered:
          </label>
          <input
            id="last_water"
